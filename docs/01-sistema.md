...
| `Avatar` | Circular para personas y contactos; `square` (`rounded-md`) para propiedades, unidades, materiales, archivos. Fallback de iniciales **negro sobre blanco fijo en ambos temas** con `ring-1 ring-border-default`; `tone` explícito opcional con tokens. Tamaños 20 · 24 · 32 · 40 |
